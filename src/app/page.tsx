...
// Define types for SearchParamsWrapper
type SearchParamsWrapperProps = {
  children: (props: { isLandingPage: boolean }) => ReactNode;
};
...
export default function Home() {
  ...
  // Check authentication status on page load with the isLandingPage parameter from SearchParamsWrapper
  const handleSessionCheck = (isLandingPage: boolean) => {
    useEffect(() => {
  ...
  return (
    <Suspense fallback={
      ...
      <SearchParamsWrapper>
        {({ isLandingPage }: { isLandingPage: boolean }) => {
          // Call the effect to check session based on isLandingPage
